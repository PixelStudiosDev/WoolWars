...
public class ArenasMenu extends Menu {
    ...
    public Map<Integer, MenuItem> getItems() {
        if (Menus.ARENAS_MENU_FILLER_ENABLED.getAsBoolean()) {
            addFiller(ItemBuilder.fromConfig(Menus.ARENAS_MENU_FILLER.getAsConfigSection()).build(), Menus.ARENAS_MENU_FILLER_SLOTS.getAsIntegerList());
        }
        ...
        items.put(Menus.ARENAS_MENU_CLOSE_ITEM_SLOT.getAsInt(), new MenuItem(ItemBuilder.fromConfig(Menus.ARENAS_MENU_CLOSE_ITEM.getAsConfigSection()).build(), player)
