...
public class SprintAbility extends Ability {
    ...
    public SprintAbility(ConfigurationSection section) {
        super(section);
    }
    ...
    public void execute(Player player, Arena arena) {
        ...
        player.addPotionEffect(new PotionEffect(PotionEffectType.SPEED, section.getInt("effect.duration") * 20, section.getInt("effect.amplifier")));
    }
